...
@section('content')
    <el-row class="pb-2">
        <el-col :md="24">
            <el-card>
                <div slot="header"><i class="el-icon-view text-primary"></i> View Term Period Event</div>
                <div>
                    ...
                    <div>
                        <a href="{{route('termperiodevent.index')}}">
    ...
    <script>
        new Vue({
            ...
            mounted() {
                ...
                axios.get('{{route('api.termperiodevent.find', $termperiodevent)}}')
                    .then(res => {
                        this.form = res.data;
                    })
                    .catch(err => {
