...
@section('content')
    <el-row class="pb-2">
        <el-col :md="24">
            <el-card>
                <div slot="header"><i class="el-icon-view text-primary"></i> View Address Type</div>
                <div>
                    ...
                    <div>
                        <a href="{{route('addresstype.index')}}">
    ...
    <script>
        new Vue({
            ...
            mounted() {
                ...
                axios.get('{{route('api.addresstype.find', $addresstype)}}')
                    .then(res => {
                        this.form = res.data;
                    })
                    .catch(err => {
