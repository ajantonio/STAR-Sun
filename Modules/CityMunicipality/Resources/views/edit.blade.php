...
@section('content')
    <el-row class="pb-2">
        <el-col :md="24">
            <el-card>
                <div slot="header"><i class="el-icon-edit text-primary"></i> Edit CityMunicipality</div>
                <div>
    ...
    <script>
        new Vue({
            ...
            mounted() {
                ...
                axios.get('{{route('api.citymunicipality.find', $id)}}')
                    .then(res => {
                        this.form = res.data;
                    })
                    .catch(err => {
            ...
            methods: {
                submitForm(formRefs) {
                    this.$refs[formRefs].validate((valid) => {
                        if (valid) {
                            axios.put('{{route('api.citymunicipality.update', $id)}}', this.form)
                                .then(res => {
