...
<button onclick="deleteLink('{{$link->id}}')" class="btn btn-xs btn-outline-danger" data-toggle="modal" data-target="#modal-delete-link-{{$link->id}}"><i class="fa fa-trash"></i></button>
<!-- Modal -->
