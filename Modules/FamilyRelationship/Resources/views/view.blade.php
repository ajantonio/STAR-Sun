...
@section('content')
    <el-row class="pb-2">
        <el-col :md="24">
            <el-card>
                <div slot="header"><i class="el-icon-view text-primary"></i> View FamilyRelationship</div>
                <div>
                    ...
                    <div>
                        <a href="{{route('familyrelationship.index')}}">
    ...
    <script>
        new Vue({
            ...
            mounted() {
                ...
                axios.get('{{route('api.familyrelationship.find', $familyrelationship)}}')
                    .then(res => {
                        this.form = res.data;
                    })
                    .catch(err => {
