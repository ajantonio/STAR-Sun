    ...
    <footer class="main-footer text-light">
        ...
        <div class="float-right d-none d-sm-inline">
            <div class="icon-bar mr-5" style="font-size: 22px">
                <a href="https://www.facebook.com/asiapacificcollege.edu/" target="_blank"><i
                ...
                <a href="https://www.linkedin.com/school/asiapacificcollege/" target="_blank"><i
                        class="fab fa-linkedin"></i></a>
            </div>
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020 <a href="https://www.apc.edu.ph" target="_blank">Asia Pacific
